...
// import { RiUserLine, RiMailLine, RiLockPasswordLine, RiGoogleFill, RiArrowRightLine } from "react-icons/ri";
...
//   return (
//     <div className="min-h-screen bg-gradient-to-br from-[#EEEFFB] via-[#F6F5FF] to-[#E8E7FF] flex items-center justify-center p-4">
//       <motion.div
...
//               whileTap={{ scale: 0.98 }}
//               type="submit"
//               className="w-full bg-gradient-to-r from-[#7E33E0] to-[#FB2E86] text-white py-3 rounded-xl font-semibold font-lato
//               hover:shadow-lg transition-shadow duration-200 flex items-center justify-center gap-2"
//             >
//               Create Account
...
//             whileHover={{ scale: 1.02 }}
//             whileTap={{ scale: 0.98 }}
//             className="w-full flex items-center justify-center gap-2 bg-white text-[#6E7191]
//             py-3 rounded-xl font-semibold font-lato hover:shadow-lg transition-shadow duration-200
//             border border-[#EEEFFB]"
//           >
//             <RiGoogleFill className="w-5 h-5 text-[#DB4437]" />
...
//             className="text-center pt-4 font-josefin text-[#6E7191]"
//           >
//             Already registered? {" "}
//             <button
//               onClick={() => router.push("/login")}
//               className="text-[#7E33E0] hover:underline font-semibold"
//             >
//               Sign in here
//             </button>
//           </motion.div>
...
//       {/* User Profile Preview (Add to Header/Navbar) */}
//       <div className="fixed top-4 right-4 group">
//         <button className="w-10 h-10 rounded-full bg-[#7E33E0] text-white flex items-center justify-center">
//           {firstName[0]}{lastName[0]}
//         </button>
        
//         <div className="hidden group-hover:block absolute right-0 top-12 bg-white shadow-xl rounded-lg p-4 min-w-[200px]">
//           <div className="text-center mb-3">
//             <p className="font-lato text-[#7E33E0]">{firstName} {lastName}</p>
//             <p className="font-josefin text-sm text-[#6E7191]">{email}</p>
//           </div>
//           <button className="w-full py-2 text-red-500 hover:bg-gray-100 rounded-lg font-josefin">
//             Logout
//           </button>
//         </div>
//       </div>
